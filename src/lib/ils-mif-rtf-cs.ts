...
export type IlsRtfRowValues = {
  ...
  communitySupportsServicesEndDate: string;
...
const RTF_HEADER_ALIASES: Record<keyof IlsRtfRowValues, string[]> = {
  ...
  communitySupportsServicesEndDate: [
    'communitysupportsservicesenddate',
    'communitysupportsserviceenddate',
    'csservicesenddate',
    'communitysupportenddate',
  ],
  rtfProductionDate: [
...
const valueForField = (field: keyof IlsRtfRowValues, row: IlsRtfRowValues): string | number | '' => {
  switch (field) {
    ...
    case 'communitySupportsServicesEndDate':
      return row.communitySupportsServicesEndDate;
