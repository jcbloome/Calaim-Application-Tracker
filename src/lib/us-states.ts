export const US_STATE_OPTIONS: Array<{ code: string; name: string }> = [
...
const STATE_CODE_SET = new Set(US_STATE_OPTIONS.map((s) => s.code));
const STATE_NAME_TO_CODE = new Map(
  US_STATE_OPTIONS.map((s) => [s.name.toLowerCase(), s.code])
);
