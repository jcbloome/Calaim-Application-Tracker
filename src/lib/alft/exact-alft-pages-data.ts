...
const yesNoOptions: ExactAlftQuestionOption[] = [
  { value: 'yes', label: 'Yes' },
  { value: 'no', label: 'No' },
];

const adlScale: ExactAlftQuestionOption[] = [
...
const frequencyOptions: ExactAlftQuestionOption[] = [
...
export const EXACT_ALFT_PAGES: ExactAlftPage[] = [
  {
    id: 'page1',
