...
export const formSchema = z.object({
    ...
    ispSecondaryContactSameAsPrimary: z.boolean().optional().nullable().transform(val => val === true),
    ...
    ispSecondaryFirstName: optionalString,
    ispSecondaryLastName: optionalString,
    ispSecondaryRelationship: optionalString,
    ispSecondaryPhone: optionalPhone,
    ispSecondaryEmail: optionalEmail,
