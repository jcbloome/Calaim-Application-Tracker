        ...
        <CardContent className="space-y-4">
          <div className="prose prose-sm max-w-none text-gray-700 space-y-2 p-4 border rounded-lg bg-muted/30">
            ...
            <div>
              ...
              <p>
                This is the most direct pathway. If the member already receives SSI, the monthly payment is
                automatically bumped up to the NMOHC rate (approximately $1,626.07 in 2026) once they move into a
                licensed Residential Care Facility for the Elderly (RCFE). Of this amount, the member typically keeps
                a small Personal Needs Allowance (around $182), and the remainder is paid to the facility for room and
                board.
              </p>
              ...
              <p>
                If the SSDI/SSA check is, for example, $1,200, it is higher than the standard SSI limit, but lower
                than the NMOHC rate ($1,626.07).
              </p>
              <p className="font-semibold">How it works</p>
              <p>
                Once the member moves into assisted living, SSA considers the NMOHC rate as the new income ceiling.
                Because a $1,200 income is below that ceiling, the member may become eligible for a small SSI
                supplement. This technical SSI eligibility then triggers the full NMOHC rate for the facility.
              </p>
            </div>
          </div>
        </CardContent>
