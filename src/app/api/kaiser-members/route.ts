  ...
  try {
    ...
    if (!preferCaspio) {
      ...
      const transformedMembers = cached.map((member: any) => ({
        ...
        ISP_Location_Type: pickFirstPopulated(member, ['ISP_Location_Type']),
        ISP_Contact_Location: pickFirstPopulated(member, ['ISP_Contact_Location']),
        ...
        ISP_Contact_Address: pickFirstPopulated(member, ['ISP_Contact_Address']),
        ISP_Contact_City: pickFirstPopulated(member, ['ISP_Contact_City', 'ISP_Current_City', 'Member_City', 'MemberCity', 'City']),
        ISP_Contact_State: pickFirstPopulated(member, ['ISP_Contact_State']),
        ISP_Contact_Zip: pickFirstPopulated(member, ['ISP_Contact_Zip']),
        ...
        Auth_Ext_Request_Date_H2022: member.Auth_Ext_Request_Date_H2022 || '',
