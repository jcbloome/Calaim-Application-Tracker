...
const MEMBERS_SELECT_FIELDS: string[] = [
  ...
  'Best_Contact_Number',
  'Best_Phone',
  'Authorized_Party_First',
  'Authorized_Party_Last',
  'Authorized_Party_Phone',
  'Authorized_Party_Email',
  'Authorized_Party_Relationship',
  'Member_Email',
  'Senior_Email',
  'Member_Address',
  'Member_City',
  ...
  'ISP_RN',
  'ISP_Social_Worker',
  'Kaiser_North_or_South',
  'Requested_Tier_Level',
  'Tiered_Level_of_Care',
  'Verified_Move_In_Date',
  'Move_In_Date',
  'Date_Member_Moved_Into_Facility',
  'Client_Financial_Responsibility',
  'Financial_Responsibility',
  'Members_Financial_Responsibility',
  // Member normal/home address fields used for ALFT page 2 home address prefill.
  ...
  'Date_Modified',
  'Date_Created',
  'Kaiser_T2038_Requested',
  'Kaiser_T2038_Requested_Date',
  'Kaiser_T2038_Received_Date',
  'Kaiser_T2038_Received',
  'Kaiser_T038_Received',
  'Kaiser_Tier_Level_Requested',
  'Kaiser_Tier_Level_Requested_Date',
  'Tier_Level_Request_Date',
  'Tier_Level_Requested_Date',
  'Tier_Request_Date',
  'Kaiser_Tier_Level_Received_Date',
  'Kaiser_Tier_Level_Received',
  'Tier_Level_Received_Date',
  'Tier_Received_Date',
